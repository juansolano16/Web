...
*/(function(c){"function"===typeof define&&define.amd?define(["jquery","datatables.net-bs4","datatables.net-responsive"],function(a){return c(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);if(!b||!b.fn.dataTable)b=require("datatables.net-bs4")(a,b).$;b.fn.dataTable.Responsive||require("datatables.net-responsive")(a,b);return c(b,a,a.document)}:c(jQuery,window,document)})(function(c){var a=c.fn.dataTable,b=a.Responsive.display,g=b.modal,e=c('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"/></div></div></div>');b.modal=function(a){return function(b,d,f){if(c.fn.modal){if(!d){if(a&&a.header){var d=e.find("div.modal-header"),h=d.find("button").detach();d.empty().append('<h4 class="modal-title">'+a.header(b)+"</h4>").append(h)}e.find("div.modal-body").empty().append(f());e.appendTo("body").modal()}}else g(b,d,f)}};return a.Responsive});;var cod_personal='';var url='';var vcolumns=[{"data":"ingreso_por"},{"data":"cargo"},{"data":"fcargo_desde"},{"data":"fcargo_hasta"},{"data":"agencia"},{"data":"f_ingreso"},{"data":"f_egreso"},{"data":"motivo_salida"},];var vcolumns2=[{"data":"nivel_instruccion"},{"data":"institucion"},{"data":"observacion"},];var vcolumnDefs=[{targets:[-3,-2],class:'text-center',},];$(document).ready(function(){url=window.location.pathname;CargarRhCargos();CargarRhEstudios();});function CargarRhCargos(){cod_personal=$('#id_cod_personal').val();var data={'action':'searchCargos','cod_personal':cod_personal}
sendDataAjax(url,data,function(json){llenarTabla(id='tblCargos',list=json,columns=vcolumns,columnDefs=vcolumnDefs,pagelen=10)});};function CargarRhEstudios(){cod_personal=$('#id_cod_personal').val();var data={'action':'searchEstudios','cod_personal':cod_personal}
